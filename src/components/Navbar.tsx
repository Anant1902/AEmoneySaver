  ...
  return (
    ...
    <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div className="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="../SignInPage" className="text-sm font-semibold leading-6 text-gray-900">
    ...
    // <Navbar className="bg-rose-100">
    //   <Container className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    //     <Navbar.Brand href="../">BB</Navbar.Brand>
    //     <Navbar.Toggle aria-controls="basic-navbar-nav" />
    //     <Navbar.Collapse id="basic-navbar-nav">
    //       <Nav className="me-auto">
    //         <Nav.Link href="#home">Marketplace</Nav.Link>
    //         <Nav.Link href="#link">Request a Product</Nav.Link>
    //         <Nav.Link href="#link">Hot Buys</Nav.Link>
